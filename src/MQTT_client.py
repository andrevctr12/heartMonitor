...
def on_connect(client, userdata, flags, rc):
    ...
    result, mid = client.subscribe('/LosAgeless/heartbeat')
    print('Inscrevendo-se no tópico "/LosAgeless/heartbeat" (%d)' % mid)
...
def on_message(client, userdata, msg):
    ...
    if msg.topic == '/LosAgeless/heartbeat':
...
def send_message(msg):
    ...
    # client.username_pw_set(MQTT_AUTH.user, MQTT_AUTH.pwd)
    client.connect(MQTT_ADDRESS, MQTT_PORT, MQTT_TIMEOUT)
    result, mid = client.publish('/LosAgeless/heartbeat', msg)
